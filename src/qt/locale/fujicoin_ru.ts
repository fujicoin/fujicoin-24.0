...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s попытался открыть на прослушивание порт %u. Этот порт считается "плохим". Вероятность, что узлы Fujicoin Core к нему подключатся, крайне мала. Подробности и полный список плохих портов в документации: doc/p2p-bad-ports.md. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неверным. Информация станет верной после завершения синхронизации с сетью Fujicoin. Прогресс синхронизации вы можете видеть снизу.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Путь к скрипту, совместимому с Fujicoin Core (напр. C:\Downloads\hwi.exe or /Users/you/Downloads/hwi.py). Внимание: остерегайтесь вредоносных скриптов!</translation>
    </message>
    <message>
