...
BOOST_FIXTURE_TEST_CASE(package_cpfp_tests, TestChain100Setup)
{
    ...
    // fee deltas. This should be taken into account. De-prioritise the parent transaction by -1FJC,
    ...
    // Package CPFP: Even though the parent pays 0 absolute fees, the child pays 1 FJC which is
