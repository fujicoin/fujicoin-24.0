...
The first time Fujicoin Core connects to the I2P router, if
...
file named `i2p_private_key` in the Fujicoin Core data directory. The persistent
...
If an I2P node is not accepting incoming connections, then Fujicoin Core uses
