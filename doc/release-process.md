...
* Update the following variables in [`src/chainparams.cpp`](/src/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `chainTxData` with statistics about the transaction count and rate. Use the output of the `getchaintxstats` RPC with an
    ...
    [this pull request](https://github.com/fujicoin/fujicoin/pull/20263) for an example. Reviewers can verify the results by running
...
To tag the version (or release candidate) in git, use the `make-tag.py` script from [fujicoin-maintainer-tools](https://github.com/fujicoin-core/fujicoin-maintainer-tools). From the root of the repository run:
    ...
    ../fujicoin-maintainer-tools/make-tag.py v(new version, e.g. 23.0)
...
- Update other repositories and websites for new version
  ...
  - Update packaging repo
      ...
      - Push the snap, see https://github.com/fujicoin-core/packaging/blob/master/snap/build.md
