...
**Failure consideration:** if fujicoind unexpectedly halts after `m_stop_use` is set on
...
When fujicoind initializes again, what began as the snapshot chainstate is now
